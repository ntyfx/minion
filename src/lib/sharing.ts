...
export const BUILTIN_TEMPLATES = [
  {
    ...
    content: "查询 {appId} 在 Adnext 的 campaign 列表",
    category: "adnext",
    params: [{ key: "appId", label: "App ID" }],
  },
  {
    name: "查询 Box 素材",
    nameEn: "Search Box Assets",
    content: "在 G123 Box 中搜索 {appId} 的广告素材",
    category: "box",
    params: [{ key: "appId", label: "App ID" }],
  },
  {
    name: "查询礼包列表",
    nameEn: "Query Gift Packs",
    content: "查询 Gift 中 {appId} 的礼包列表",
    category: "gift",
    params: [{ key: "appId", label: "App ID" }],
  },
  {
    ...
    content: "帮我检查 {appId} 从 Artifex 到 Adnext 的广告素材投放链路",
  ...
  },
  {
    ...
    content: "帮我追溯 {assetName} 在 E-system、Box、Adnext 中的状态",
    category: "cross-system",
